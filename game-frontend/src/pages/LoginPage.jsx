...
export default function LoginPage() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen w-screen bg-gradient-to-br from-black via-gray-900 to-black px-4">
      <div className="bg-gray-950 border border-gray-800 shadow-2xl rounded-2xl p-10 w-full max-w-md">
        ...
        <form onSubmit={handleLogin} className="space-y-5">
          ...
          <button
            type="submit"
            className="w-full px-4 py-2 bg-gradient-to-r from-indigo-500 via-purple-600 to-indigo-500 text-black font-bold rounded-full shadow-lg hover:from-pink-400 hover:to-indigo-400 hover:text-white transition-all duration-300 border border-transparent hover:border-white"
          >
            🚀 Log In
          </button>
        </form>
